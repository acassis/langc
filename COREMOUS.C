...
void main()
{
   ...
   char ch;
   int ct=10,c1=0,c2=1,c3=0,c4=1,c5=0;
   float px=160,py=100,x1=10,x2=120,x3=150,x4=140,x5=160,y1=50,y2=160,y3=130,y4=100,y5=50,ct1=1,ct2=0.5,ct3=1,ct4=0.5,ct5=1;
